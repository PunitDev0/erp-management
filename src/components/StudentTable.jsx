...
export default function StudentAdmissionForm() {
  ...
  return (
    ...
    >
      <div className="">
        <Card className="w-full p-0 border-double border-2 border-indigo-200 rounded-3xl shadow-xl bg-white">
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                <div className="bg-indigo-700 text-white p-4 rounded-t-2xl">
                  <h2 className="text-lg font-semibold flex items-center">
                    <User className="mr-2 h-5 w-5" /> Personal Details
                  </h2>
                </div>
              ...
              >
                <div className="bg-indigo-700 text-white p-4 rounded-t-2xl">
                  <h2 className="text-lg font-semibold flex items-center">
                    <User className="mr-2 h-5 w-5" /> Family Details
                  </h2>
                </div>
                <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
              ...
              >
                <div className="bg-indigo-700 text-white p-4 rounded-t-2xl">
                  <h2 className="text-lg font-semibold flex items-center">
                    <User className="mr-2 h-5 w-5" /> Guardian Details
                  </h2>
                </div>
                <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
              ...
              >
                <div className="bg-indigo-700 text-white p-4 rounded-t-2xl">
                  <h2 className="text-lg font-semibold flex items-center">
                    <FileText className="mr-2 h-5 w-5" /> Administrative
                  </h2>
                </div>
                <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
              ...
              >
                <div className="bg-indigo-700 text-white p-4 rounded-t-2xl">
                  <h2 className="text-lg font-semibold flex items-center">
                    <FileText className="mr-2 h-5 w-5" /> Academic Details
                  </h2>
                </div>
